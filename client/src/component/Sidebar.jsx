...
const Sidebar = () => {
  const {
    ...
    selectedUser,
    setSelectedUser,
    unseenMessages = {}, // default empty object for safety
    setUnseenMessages,
  } = useContext(ChatContext);

  const { logout, onlineUser } = useContext(AuthContext);

  const [input, setInput] = useState(""); // fixed: was boolean, should be string
  ...
  // Fetch users whenever online users list changes
  useEffect(() => {
    getUsers();
  }, [onlineUser]);
